...
class StatisticAspForeigner extends Model
{
    protected $fillable = ['id_student', 'id_faculty', 'id_speciality', 'id_specialization',
        ...
        'id_plan', 'is_chosen', 'id_competition', 'foreigner', 'yellowline', 'acceptCount'];

    public function student() {
        return $this->belongsTo(StudentAspForeigner::class, 'id_student');
    }
    ...
    public function score() {
        return $this->hasMany(ScoreAspForeigner::class, 'id_statistic');
    }
