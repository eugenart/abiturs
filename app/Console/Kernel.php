...
//        $schedule->command('filesxls:delete')->cron('0 */2 * * *'); // every 2 hours
        ...
        $schedule->command('parsing:begin')->everyFiveMinutes()->appendOutputTo(storage_path() .'/app/public/logs/schedule_parse_log.log')->sendOutputTo(storage_path() .'/app/public/logs/mail.log')->emailOutputTo('kirdyashkinaei@mrsu.ru');
