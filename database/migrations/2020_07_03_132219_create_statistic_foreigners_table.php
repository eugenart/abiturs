...
class CreateStatisticForeignersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statistic_foreigners', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('statistic_foreigners');
    }
}
