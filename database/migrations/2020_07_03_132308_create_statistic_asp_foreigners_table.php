...
class CreateStatisticAspForeignersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statistic_asp_foreigners', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('statistic_asp_foreigners');
    }
}
