        ...
        <div class="row mt-4">
            <div class="col-12 mb-3" v-for="(archive, index) in archives">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gsdfsdfsd">
                            <div class="col-4" v-for="(block, index) in blocks"  v-if="block.archive_ob.id === archive.id">
                                <div class="card mb-3 infoblock-сard-text" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="ml-2 mb-1"><a :href="rootUrl + '/'+block.url"
                                                                    target="_blank">{{ block.url }}</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
