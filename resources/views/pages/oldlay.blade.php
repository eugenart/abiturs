        ...
        <div class="row underline-row">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-4 padding__with__header">
                ...
                <div class="position">
                    <table border="0" class="footer-table">
                        <tr>
                            <td class=""><div class="pos"><img src="{{asset('storage/images/mrsu2021/2I.svg')}}"></div></td>
                            <td><div class="pos-text"><a href="https://yandex.ru/maps/-/CCUYE4CjoB">Большевистская ул., 68/1</a></div></td>
                        </tr>
                        <tr>
                            <td class=""><div class="pos"><img class="image_footer" src="{{asset('storage/images/mrsu2021/1E.svg')}}"></div></td>
                            <td><div class="pos-text"><a href="mailto:dep-general@adm.mrsu.ru">dep-general@adm.mrsu.ru</a></div></td>
                        </tr>
                        <tr>
                            <td class=""><div class="pos__mobile"><img class="image_footer" src="{{asset('storage/images/mrsu2021/9H.svg')}}"></div></td>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-4 padding__with__header">
                ...
                <div class="position">
                    <table border="0" class="footer-table">
                        <tr>
                            <td class=""><div class="image_footer_glob"><img class="" src="{{asset('storage/images/mrsu2021/6I.svg')}}"></div></td>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-4 padding__with__header">
                ...
                <div class="position">
                    <table border="0" class="footer-table">
                        <tr>
                            <td class=""><div class="pos"><img class="image_footer" src="{{asset('storage/images/mrsu2021/2I.svg')}}"></div></td>
                            <td><div class="pos-text"><a href="https://yandex.ru/maps/-/CCUYE4gASD">Полежаева ул., 44</a></div></td>
                        </tr>
                        <tr>
                            <td class=""><div class="pos"><img class="image_footer" src="{{asset('storage/images/mrsu2021/1E.svg')}}"></div></td>
                        ...
                        <tr>
                            <td class=""><div class="pos__mobile"><img class="image_footer" src="{{asset('storage/images/mrsu2021/9H.svg')}}"></div></td>
                            <td><div class="pos-text"><a href="tel:88002221317">+7 (800) 222-13-17</a></div></td>
                        </tr>
                        <!-- <tr> -->
                        <!-- <td></td> -->
                        <!-- <td><p class="top-margin"><a href="" class="underline">Показать на карте</a></p></td> -->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-4 padding__with__header">
                ...
                <div class="position__list">
                    <ul class="list_footer">
                        <li><a href="/sveden/common/" class="underline">Сведения об образовательной организации</a></li>
                        <li><a href="/ru/university/anticorr/" class="underline">Противодействие коррупции</a></li>
                        <li><a href="/ru/university/contacts/" class="underline">Контакты</a></li>
                        <li><a href="https://iptel.mrsu.ru/" class="underline">Телефонный справочник</a></li>
                        <li><a href="https://pay.mrsu.ru/" class="underline">Оплата услуг</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row foot-bottom-block">
            <div class="col-lg-6 col-md-6 col-sm-6 mb-4 col_one padding__with__header">
                <p class="copyright">© 1998–2021 МГУ им. Н.П. Огарёва<br>
                    При использовании материалов сайта ссылка на источник обязательна</p>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 mb-4 social col_two padding__with__header__icon">
                <a href="https://vk.com/mrsu13"><img class="size__image__footer" src="{{asset('storage/images/mrsu2021/VK.svg')}}" alt=""></a>
                <a href="https://www.facebook.com/MordovskijUniversitet"><img class="size__image__footer" src="{{asset('storage/images/mrsu2021/Facebook.svg')}}" alt=""></a>
                <a href="https://twitter.com/Ogarev_mrsu"><img class="size__image__footer" src="{{asset('storage/images/mrsu2021/Twitter.svg')}}" alt=""></a>
                <a href="https://www.instagram.com/ogarev_mrsu/"><img class="size__image__footer" src="{{asset('storage/images/mrsu2021/Instagram.svg')}}" alt=""></a>
                <a href="https://www.youtube.com/user/OgarevTV"><img class="size__image__footer" src="{{asset('storage/images/mrsu2021/Youtube.svg')}}" alt=""></a>
            </div>
        </div>
    </div>
</footer>
