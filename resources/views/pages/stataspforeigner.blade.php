...
@section('page')
    ...
    <div class="container">
        <div class="row mt-lg-5 mt-xl-5 mt-md-3 mt-sm-3 mt-3">
            <div class="col-12">
                ...
                <h3 class="text-center h1-mrsu main-color m-0">Аспирантура и ординатура</h3>
                                        ...
                                        @foreach($files_xls as $file_xls_stat)
                                            <li>
                                                ...
                                                <div class="file-link-div ">
                                                    ...
                                                    <a href="{{ asset('storage/files-xls-stat/aspf/' . $file_xls_stat) }}"
                                                       target="_blank">
                                                        {{substr($file_xls_stat, 0, -4)}}
                                                    </a>
                                                    <br>
                                                    <span>{{round(stat($_SERVER['DOCUMENT_ROOT'] . '/storage/files-xls-stat/aspf/' . $file_xls_stat)[7] / 1024 /1024, 2)}} MB</span>
                                                </div>
                                            </li>
                                        @endforeach
                                    @else
    ...
    <div class="container pt-0 padding-0 mt-lg-4 mt-xl-4 mt-md-3 mt-sm-3 mt-3">
        <form class="ovz-form" action="{{ route('stataspforeigner.index') }}" id="sendFormWithFacultets" method="get">
            <div class="row">
