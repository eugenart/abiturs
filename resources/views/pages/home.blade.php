            ...
            @if (count($slider))
                <div class="row">
                    <div class="col-12 mt-4">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide img_main" data-ride="carousel">
                        ...
                        <div id="carouselExampleIndicators1" class="carousel slide img_ipad" data-ride="carousel">
                            <ol class="carousel-indicators">
                        ...
                        <div id="carouselExampleIndicators2" class="carousel slide img_mobile" data-ride="carousel">
                            <ol class="carousel-indicators">
                ...
                @if (count($slider_f))
                    <div class="row">
                        <div class="col-12 mt-4">
                            ...
                            <div id="carouselExampleIndicatorsf" class="carousel slide img_main" data-ride="carousel">
                                <ol class="carousel-indicators">
                            ...
                            <div id="carouselExampleIndicatorsf1" class="carousel slide img_ipad" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    @foreach($slider_i_f as $slide)
                                        @if ($loop->index == 0)
                                            <li data-target="#carouselExampleIndicatorsf1" data-slide-to="{{ $loop->index }}"
                                                class="active"></li>
                                        @else
                            ...
                            <div id="carouselExampleIndicatorsf2" class="carousel slide img_mobile" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    @foreach($slider_m_f as $slide)
                                        @if ($loop->index == 0)
                                            <li data-target="#carouselExampleIndicatorsf2" data-slide-to="{{ $loop->index }}"
                                                class="active"></li>
                                        @else
