                ...
                <div class="row">
                        ...
                        <table
                            ...
                            <tr>
                                <th scope="row" class="text-right"><span
                                        class="font-weight-bold main-color">{{ trans('contacts.tel_title') }}</span></th>
                                <td>
                                    ...
                                    <a class= 'main-color' href="tel:88342223230">8 (8342) 22-32-30 </a>({{ trans('contacts.add') }} 1081)
                                    <br>
                            ...
                            <tr>
                                <th scope="row" class="text-right"><span
                                        class="font-weight-bold main-color">{{ trans('contacts.adr_title') }}</span></th>
                            ...
                            <tr>
                                <th scope="row" rowspan="3" class="text-right"  style="border-bottom: 1px solid #dee2e6"><span
                                        class="main-color font-weight-bold">{{ trans('contacts.time_title') }}</span></th>
                                <td colspan="2">{{ trans('contacts.time_monfr') }}<br/> {{ trans('contacts.time_break') }}
                                </td>
                            </tr>
                            <tr>
                                {{--                            <th scope="row"></th>--}}
                    ...
                    <div class="col-lg-6 col-md-12" id="to-hide">
                        ...
                        <form id="contactform" method="GET" action=""
                            ...
                            @csrf
                            <input name="fio" id="fio" pattern="^[A-Za-zА-Яа-яЁё\s]+$" type="text" placeholder="{{ trans('contacts.form_fio') }}"
                                   value=""
                                   required>
                            ...
                            <textarea name="question" id="question" cols="60" rows="5" placeholder="{{ trans('contacts.form_text') }}"
                                      required></textarea>
