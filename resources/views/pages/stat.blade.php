...
{{--    {{var_dump($news)}}--}}
    ...
    <div class="container-fluid pt-0 padding-0 mb-5 mt-xl-3">
        <div class="row">
            <div class="col-12">
                <div class="text-center m-4 h4">Уважаемые посетители, на сайте ведутся технические работы. Просим прощения за доставленные неудобства. Информация появиться в ближайшее время.
                </div>
            </div>
        </div>
    </div>
