    ...
    <div class="container-fluid pt-0 padding-0 mb-5 mt-xl-3">
        <div class="row">
            <div class="col-12">
                                                                                        ...
                                                                                        @foreach($admissionBasis->abiturs as $k => $abitur)
                                                                                            ...
                                                                                            @else
                                                                                                <tr class="text-center">
                                                                                                    ...
                                                                                                    <td class="text-left"
                                                                                                        id="stud-{{$abitur->student->id}}-{{$abitur->id_speciality}}">{{$abitur->student->snils2}}
                ...
                @else
                    @if(!isset($notification_green))
                        <div class="text-center m-4 h4">Введите <b>СНИЛС</b> или выберите <b>факультет/институт</b>
                            для
