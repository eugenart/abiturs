...
@section('page')
    ...
    <div class="container">
        <div class="row mt-lg-5 mt-xl-5 mt-md-3 mt-sm-3 mt-3">
            <div class="col-12">
                <h1 class="text-center h1-mrsu main-color m-0">Магистратура</h1>
            </div>
        </div>
    </div>
                                ...
                                <ul class="files-list">
                                    ...
                                    @if(!empty($files_xls))
                                        @foreach($files_xls as $file_xls_stat)
                                            @if(round(stat($_SERVER['DOCUMENT_ROOT'] . '/storage/files-xls-stat/master/' . $file_xls_stat)[7] / 1024 /1024, 2) >0)
                                                <li>
                                                    <div>
                                                        @if(file_exists($_SERVER['DOCUMENT_ROOT'] . '/storage/file-types/xls.png'))
                                                            <img width="60px" height="60px"
